...
library(readr)
library(dplyr)
library(ellmer) # TODO: renv::install("ellmer@0.4.0") in case of loading error
...
#' 
#' 3. Setup your LLM using the Hugging Face API token and the model "openai/gpt-oss-20b:together"
#' 
